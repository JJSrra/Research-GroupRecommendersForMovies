...
if __name__ == "__main__":
    ...
    predicted_random_pogrs_rankings = evaluation.generate_pogrs_predictions(
        random_groups, random_evaluated_movies, test_ratings_by_user, pearson, "generated_data/rankings/predicted_random_pogrs.txt")
    ...
    predicted_buddies_pogrs_rankings = evaluation.generate_pogrs_predictions(
        buddies_groups, buddies_evaluated_movies, test_ratings_by_user, pearson, "generated_data/rankings/predicted_buddies_pogrs.txt")
    ...
    predicted_random_empathy_rankings = evaluation.generate_empathy_predictions(
        random_groups, random_evaluated_movies, test_ratings_by_user, pearson, "generated_data/rankings/predicted_random_empathy.txt")
    ...
    predicted_buddies_empathy_rankings = evaluation.generate_empathy_predictions(
        buddies_groups, buddies_evaluated_movies, test_ratings_by_user, pearson, "generated_data/rankings/predicted_buddies_empathy.txt")
    ...
    predicted_random_optimist_rankings = evaluation.generate_optimist_predictions(
        random_groups, random_evaluated_movies, train_ratings_by_user, test_ratings_by_user, pearson, "generated_data/rankings/predicted_random_optimist.txt")
    ...
    predicted_buddies_optimist_rankings = evaluation.generate_optimist_predictions(
        buddies_groups, buddies_evaluated_movies, train_ratings_by_user, test_ratings_by_user, pearson, "generated_data/rankings/predicted_buddies_optimist.txt")
